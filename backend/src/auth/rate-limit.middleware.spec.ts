...
function mockRes(): Partial<Response> & { headers: Record<string, any>; statusCode?: number; body?: any } {
  ...
  const res: any = {
    ...
    json: jest.fn((body: any) => { resolvedBody = body; return res; }),
    get statusCode() { return statusCode; },
    get body() { return resolvedBody; },
  };
  return res;
}
...
describe('RateLimitMiddleware', () => {
  ...
  it('should use wallet address as key when authenticated', () => {
    ...
    const req2 = mockReq({ ip: '10.0.0.1', user: { walletAddress: 'GTEST' } as any });
    const res2 = mockRes();
