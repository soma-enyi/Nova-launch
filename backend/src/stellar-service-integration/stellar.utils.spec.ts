...
describe('stellar.utils', () => {
  ...
  describe('isValidStellarAddress', () => {
    ...
    it('returns false for a C-address', () => {
      expect(
        isValidStellarAddress('CAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN'),
      ).toBe(false);
    });
  ...
  describe('isValidContractAddress', () => {
    it('returns true for a valid C-address', () => {
      expect(
        isValidContractAddress('CAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN'),
      ).toBe(true);
    });

    it('returns false for a G-address', () => {
      expect(
        isValidContractAddress('GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN'),
      ).toBe(false);
    });
  });
  ...
  describe('isValidAddress', () => {
    ...
    it('returns true for C-address', () => {
      expect(
        isValidAddress('CAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN'),
      ).toBe(true);
    });
  ...
  describe('assertValidAddress', () => {
    it('does not throw for valid address', () => {
      expect(() =>
        assertValidAddress('GAAZI4TCR3TY5OJHCTJC2A4QSY6CJWJH5IAJTGKIN2ER7LBNVKOCCWN'),
      ).not.toThrow();
    });
